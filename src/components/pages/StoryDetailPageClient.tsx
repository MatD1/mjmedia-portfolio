...
type Story = NonNullable<RouterOutputs["story"]["getById"]>;
              ...
              <ReactMarkdown
                ...
                components={{
                  ...
                  img: ({ src, alt }) => {
                    ...
                    // Normalize src to a string; handle both string and Blob inputs
                    const srcString =
                      typeof src === "string"
                        ? src
                        : src instanceof Blob
                    ...
                    const isRelativeUrl =
                      srcString.startsWith("/api/media-alt/") ||
                      srcString.startsWith("/api/media/");
        ...
        >
          <Card className="p-6">
            <div className="flex items-start gap-4">
              {story.createdBy.image && (
                <Image
                  src={story.createdBy.image}
                  alt={story.createdBy.name || "Author"}
                  width={80}
                  height={80}
