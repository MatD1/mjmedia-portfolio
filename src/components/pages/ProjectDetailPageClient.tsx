    ...
    <main className="min-h-screen py-20">
      <div className="container mx-auto px-4">
        ...
        >
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="space-y-6">
              ...
              {/* Tech Stack */}
              <div>
                <h3 className="pixel-text text-lg text-glow mb-3">
                  Tech Stack
                </h3>
        ...
        {project.content && (
          ...
          >
            <Card className="p-8">
              <h2 className="pixel-text text-2xl text-glow mb-6">
                Project Details
              </h2>
              <div className="prose prose-invert max-w-none">
                <ReactMarkdown
                  ...
                  components={{
                    h1: ({ children }) => (
                      <h1 className="pixel-text text-xl text-glow mb-4">
                        {children}
                      </h1>
                    ),
                    h2: ({ children }) => (
                      <h2 className="pixel-text text-lg text-glow mb-3">
                        {children}
                      </h2>
                    ),
                    h3: ({ children }) => (
                      <h3 className="pixel-text text-base text-glow mb-2">
                        {children}
                      </h3>
                    ),
                    p: ({ children }) => (
                    ...
                    img: ({ src, alt }: any) => {
                      ...
                      // At this point, we know src is a string
                      const srcString = src as string;

                      // Check if it's an absolute URL (external image)
                      if (srcString.startsWith("http")) {
                        return (
                          <Image
                            ...
                            width={600}
                            height={400}
                            className="w-full h-auto rounded border border-[var(--border-primary)] mb-4"
                            unoptimized
                          />
                        );
                      }
