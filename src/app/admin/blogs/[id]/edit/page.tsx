...
export default function EditBlogPage() {
  ...
  const { data: blog, isLoading } = api.blog.getById.useQuery(
    { id: blogId },
    { enabled: !!blogId }
  );
  ...
  if (!blog) {
    return (
      <div className="text-center py-20">
        <h3 className="pixel-text text-xl text-glow mb-2">Blog Post Not Found</h3>
    ...
    <div className="space-y-8">
      ...
      >
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            <h1 className="pixel-text text-3xl text-glow">Edit Blog Post</h1>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            {/* Basic Information */}
            <Card className="p-6">
              <h2 className="pixel-text text-lg text-glow mb-4">Blog Post Details</h2>
            ...
            {/* Tags */}
            <Card className="p-6">
              <h2 className="pixel-text text-lg text-glow mb-4">Tags</h2>
              ...
              <div className="space-y-4">
                ...
                <div>
                  <h3 className="pixel-text text-lg text-glow mb-2">
                    {watch('title') || 'Blog Post Title'}
                  </h3>
                  <p className="text-[var(--text-secondary)] text-sm">
                    {watch('excerpt') || 'Blog post excerpt will appear here...'}
                  </p>
                </div>
              </div>
            </Card>
